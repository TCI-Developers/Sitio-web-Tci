...
const ManagmentTeam = () => {
  return (
    <section data-aos="fade-up" id="nosotros" className='flex flex-col gap-8 p-12 text-xl md:flex-row'>
      <div className='flex flex-col md:flex-1  gap-6 font-wix py-10 '>
        ...
        <p>Detrás de cada solución de TCI hay personas con <span className='text-primary'>vocación, experiencia y una profunda compresión de los desafíos empresariales</span></p>
